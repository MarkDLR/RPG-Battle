...
sword = Item.create(name: "Sword", item_type: "Weapon", sub_type: "melee", character_equipped: false, atk: 10, def: 5, hp: 0, gold: 5)
shield = Item.create(name: "Shield", item_type: "Weapon", sub_type: "shield", character_equipped: false, atk: 0, def: 10, hp:0, gold: 5)
chestplate = Item.create(name: "Chestplate", item_type: "Armor", sub_type: "chest", character_equipped: false, atk: 0, def: 12, hp: 0, gold: 10)
gauntlets = Item.create(name: "pair of Gauntlets", item_type: "Armor", sub_type: "hands", character_equipped: false, atk: 2, def: 3, hp: 0, gold: 15)
boots = Item.create(name: "pair of Boots", item_type: "Armor", sub_type: "feet", character_equipped: false, atk: 1, def: 4, hp: 0, gold: 5)
helmet = Item.create(name: "Helmet", item_type: "Armor", sub_type: "head", character_equipped: false, atk: 0, def: 5, hp: 0, gold: 5)
battle_axe = Item.create(name: "Battle axe", item_type: "Weapon", sub_type: "melee", character_equipped: false, atk: 10, def: 0, hp: 0, gold:10)
daggers = Item.create(name: "Dagger", item_type: "Weapon", sub_type: "melee", character_equipped: false, atk: 7, def: 3, hp: 0, gold:10)
s_chestplate = Item.create(name: "Superior Chestplate", item_type: "Armor", sub_type: "chest", character_equipped: false, atk: 0, def: 20, hp: 0, gold:10)
s_helmet = Item.create(name: "Superior Helmet", item_type: "Armor", sub_type: "head", character_equipped: false, atk: 0, def: 10, hp: 0, gold:10)
s_gauntelets = Item.create(name: "pair of Superior_Gauntlets", item_type: "Armor", sub_type: "hands", character_equipped: false, atk: 6, def: 9, hp: 0, gold:30)
s_daggers = Item.create(name: "Superior Dagger", item_type: "Weapon", sub_type: "melee", character_equipped: false, atk: 25, def: 12, hp: 0, gold:30)
s_sword = Item.create(name: "Superior Sword", item_type: "Weapon", sub_type: "melee", character_equipped: false, atk: 30, def: 15, hp: 0, gold:40)
s_shield = Item.create(name: "Superior Shield", item_type: "Weapon", sub_type: "shield", character_equipped: false, atk: 0, def: 30, hp:0, gold:45)
